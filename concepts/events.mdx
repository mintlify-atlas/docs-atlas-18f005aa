---
title: Event System
description: Understanding Baileys event system, BaileysEventMap, and event handling patterns
---
...
- [Connection Lifecycle](/concepts/connection) - Connection events
- [Authentication](/concepts/authentication) - Credential events
- [Message Store](/concepts/message-store) - Storing event data