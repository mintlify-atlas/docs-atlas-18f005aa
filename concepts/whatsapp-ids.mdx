---
title: WhatsApp IDs (JIDs)
description: Understanding WhatsApp JID format, user IDs, group IDs, and JID utilities
---
...
❌ Including `+` in JIDs: `+19999999999@s.whatsapp.net`

✅ Use digits only: `19999999999@s.whatsapp.net`

❌ Mixing server types: Using `c.us` for new messages

✅ Use `s.whatsapp.net` for users: `jidNormalizedUser(jid)`

❌ String concatenation: `phoneNumber + '@s.whatsapp.net'`

✅ Use `jidEncode`: `jidEncode(phoneNumber, 's.whatsapp.net')`
</Warning>

## See Also

- [Events](/concepts/events) - Working with message keys
- [Message Store](/concepts/message-store) - Indexing messages by JID
- [Connection](/concepts/connection) - User identification